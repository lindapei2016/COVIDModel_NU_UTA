...
# Variation of Tools_InputOutput.py by including wastewater-related attributes
...
SimReplication_IO_var_names = (
    ...
    "ToIY_history",
    "S_history",
    "SE_history", # Sonny's note: store SE_history
    "wastewater_viral_load", # Sonny's note: store wastewater viral load
    "D_history",
    "ToICUD_history",
    "ToIYD_history",
    "ToRS_history",
...
SimReplication_IO_list_of_arrays_var_names = (
    "ICU_history",
    "S_history",
    "SE_history", # Sonny's note: store SE_history tell that it is an array
    "wastewater_viral_load", # Sonny's note: store wastewater viral load
    "IH_history",
    "ToIHT_history",
    "ToIY_history",
